...
static const char *SOUNDS_NAME = "weapons/scar_l.wav";

void EV_FireScarL( struct event_args_s *args )
{
	...
	if ( EV_IsLocal( idx ) )
	{
		++g_iShotsFired;
		EV_MuzzleFlash();
		gEngfuncs.pEventAPI->EV_WeaponAnimation(Com_RandomLong(SCARL_SHOOT1, SCARL_SHOOT3), 2);
