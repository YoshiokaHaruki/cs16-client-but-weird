...
static const char *SOUNDS_NAME = "weapons/xm8_shooter.wav";

void EV_FireXM8S(event_args_s *args)
{
	...
	if ( EV_IsLocal( idx ) )
	{
		++g_iShotsFired;
		EV_MuzzleFlash();
		gEngfuncs.pEventAPI->EV_WeaponAnimation( Com_RandomLong(SHARPSHOOTER_XM8_SHOOT1, SHARPSHOOTER_XM8_SHOOT3), 2 );
