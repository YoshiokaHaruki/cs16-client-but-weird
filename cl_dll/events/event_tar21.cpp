...
static const char *SOUNDS_NAME = "weapons/tar21-1.wav";

void EV_FireTAR21( struct event_args_s *args )
{
	...
	if ( EV_IsLocal( idx ) )
	{
		++g_iShotsFired;
		EV_MuzzleFlash();
		gEngfuncs.pEventAPI->EV_WeaponAnimation(Com_RandomLong(TAR21_SHOOT1, TAR21_SHOOT3), 2);
