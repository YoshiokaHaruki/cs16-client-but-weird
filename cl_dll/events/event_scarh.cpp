...
static const char *SOUNDS_NAME = "weapons/scar_h.wav";

void EV_FireScarH( struct event_args_s *args )
{
	...
	if ( EV_IsLocal( idx ) )
	{
		++g_iShotsFired;
		EV_MuzzleFlash();
		gEngfuncs.pEventAPI->EV_WeaponAnimation(Com_RandomLong(SCARH_SHOOT1, SCARH_SHOOT3), 2);
