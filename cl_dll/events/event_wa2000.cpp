...
static const char *SOUNDS_NAME = "weapons/wa2000-1.wav";

void EV_FireWA2000(event_args_s *args)
{
	...
	{
		++g_iShotsFired;
		gEngfuncs.pEventAPI->EV_WeaponAnimation(Com_RandomLong(WA2000_SHOOT, WA2000_SHOOT2), 2);
		EV_MuzzleFlash();
