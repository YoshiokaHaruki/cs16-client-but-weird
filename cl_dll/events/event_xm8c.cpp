...
static const char *SOUNDS_NAME = "weapons/xm8_carbine.wav";

void EV_FireXM8C( struct event_args_s *args )
{
	...
	if ( EV_IsLocal( idx ) )
	{
		++g_iShotsFired;
		EV_MuzzleFlash();
		gEngfuncs.pEventAPI->EV_WeaponAnimation(Com_RandomLong(CARBINE_XM8_SHOOT1, CARBINE_XM8_SHOOT3), 2);
